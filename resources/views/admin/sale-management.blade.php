                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-12 col-md-6 text-left">
                                    <div id="sampleTable_filter" class="dataTables_filter" style="display:none;">
                                        <label>Tìm kiếm:
                                            <input id="js-search" type="search" class="form-control form-control-sm"
                                ...
                                <div class="col-sm-12 col-md-6 d-flex text-right justify-content-end">
                                    ...
                                    <a class="btn btn-info btn-sm d-flex align-items-center justify-content-center"
                                        href="{{ route('admin.new-flashsale') }}" title="Thêm"
                                        style = "width: 200px; height: 50px; font-size: 14px;"
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="250">Giá Sale</th>
                                        <th width="250">Thời điểm kết thúc</th>
