...
@php
    ...
    $brand = $gaminggear->attributes->firstWhere('name', 'Brand')->pivot->value ?? 'N/A';
    $model = $gaminggear->attributes->firstWhere('name', 'Model')->pivot->value ?? 'N/A';
    $price = $gaminggear->attributes->firstWhere('name', 'Price')->pivot->value ?? 'N/A';
    $dealprice = $gaminggear->attributes->firstWhere('name', 'Deal Price')->pivot->value ?? 'N/A';
    $rating = $gaminggear->attributes->firstWhere('name', 'Rating')->pivot->value ?? 'N/A';

    // Các thuộc tính GamingGear
    $device_type = $gaminggear->attributes->firstWhere('name', '[GG] Loại thiết bị')->pivot->value ?? 'N/A';
    $connectivity = $gaminggear->attributes->firstWhere('name', '[GG] Kết nối')->pivot->value ?? 'N/A';
    $rgb_system = $gaminggear->attributes->firstWhere('name', '[GG] Hệ thống đèn RGB')->pivot->value ?? 'N/A';
    $material = $gaminggear->attributes->firstWhere('name', '[GG] Chất liệu')->pivot->value ?? 'N/A';
    $weight = $gaminggear->attributes->firstWhere('name', '[GG] Trọng lượng')->pivot->value ?? 'N/A';
    $special_features = $gaminggear->attributes->firstWhere('name', '[GG] Tính năng đặc biệt')->pivot->value ?? 'N/A';
    $ports = $gaminggear->attributes->firstWhere('name', '[GG] Cổng kết nối')->pivot->value ?? 'N/A';
    $accessories = $gaminggear->attributes->firstWhere('name', '[GG] Phụ kiện đi kèm')->pivot->value ?? 'N/A';
@endphp
            ...
            <div aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a
                            href="{{ url('/gaminggear/' . '/' . $brand) }}">{{ $gaminggear->attributes->firstWhere('id', '1')->pivot->value }}</a>
                    </li>
                </ol>
            </div>
            ...
            <div class="bg-white product-info-container">
                            ...
                            <table style="width: 100.0%;" border="1" width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            <p><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                                                    <strong><span style="line-height: 115%; color: black;">Hệ thống đèn
                                                            RGB</span></strong>
                                                </span>
                                            </p>
                                        </td>
                                        <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                            <span
                                                style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $rgb_system }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                    ...
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            <p><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                                                    <strong><span style="line-height: 115%; color: black;">Trọng
                                                            lượng</span></strong>
                                                </span>
                                            </p>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            <p><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                                                    <strong><span style="line-height: 115%; color: black;">Tính năng đặc
                                                            biệt</span></strong>
                                                </span>
                                            </p>
                                        </td>
                                        <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                            <span
                                                style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $special_features }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            <p><span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                                                    <strong><span style="line-height: 115%; color: black;">Cổng kết
                                                            nối</span></strong>
                                                </span>
                                            </p>
                                        </td>
                                        <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                            <span
                                                style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $ports }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                        ...
                                        <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                            <span
                                                style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $accessories }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="pro-info-center">
                    ...
                    <div class="pro-info-summary">
                        ...
                        <span class="item">
                            <i class="fa fa-check-circle"></i>Hệ thống đèn RGB: {{ $rgb_system }}
                        </span>
                        <span class="item">
                        ...
                        <span class="item hide d-block">
                            <i class="fa fa-check-circle"></i>Tính năng đặc biệt: {{ $special_features }}
                        </span>
                        <span class="item hide d-block">
                    ...
                    <div class="pro-button-container d-flex flex-wrap text-center justify-content-between">
                        ...
                        <form id="addCartForm" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $gaminggear_id }}">
                            <input type="hidden" name="product_type" value="gaminggear">
...
@php
    $images = collect(['Image1', 'Image2', 'Image3', 'Image4', 'Image5'])
        ->map(function ($name) use ($gaminggear) {
            $attribute = $gaminggear->attributes->firstWhere('name', $name);
