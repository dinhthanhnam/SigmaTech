...
@php
  ...
  $endDate = $laptop->attributes->firstWhere('name', 'Sale End Date')->pivot->value ?? 'N/A';
  if ($endDate) {
      $formattedDate =
  ...
  $sale_end_date = Carbon\Carbon::parse($formattedDate)->timestamp;
                ...
                <tr>
                  ...
                  <td>
                    <span style="color: #0030f2;" class="font-500">👉Quét ZALOPAY - Giảm liền tay ưu
                      ...
                      30/11/2024. <a href="https://www.anphatpc.com.vn/quet-zalopay-san-ngay-uu-dai.html"
        ...
        <tbody>
          ...
          <tr>
            <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" colspan="2" width="303">
              <p style="margin: 0cm; margin-bottom: .0001pt;"><span
                  style="font-family: arial, helvetica, sans-serif; font-size: 10pt;"><strong><span
                      style="color: black;">Bộ vi xử lý</span></strong><span style="color: black;">&nbsp;</span></span>
              </p>
            </td>
          </tr>
          <tr>
...
@push('scripts')
  ...
  <script>
    ...
    const endTime = {{ $sale_end_date }} * 1000; // 1 giờ = 3600000 milliseconds
