            ...
            <div class="bg-white product-info-container">
                                ...
                                <table style="width: 100.0%;" border="1" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                                <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $supported_memory }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            ...
                                            <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                                <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $max_memory_size }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                                            ...
                                            <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                                                <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $max_memory_channels }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                ...
                <div class="pro-info-center">
                    <h1 class="pro-name js-product-name">{{ $name }}
                        ({{ $socket }} | {{ $base_clock }} | {{ $core_count }} | {{ $thread_count }} | {{ $max_memory_size }})
                    </h1>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <span style="color: #0030f2;" class="font-500">👉Quét ZALOPAY - Giảm liền tay ưu đãi lên tới 150.000 VNĐ (Không áp dụng các sản phẩm của Apple-CPU). Áp dụng từ 01/10/2024 đến 30/11/2024. <a href="https://www.anphatpc.com.vn/quet-zalopay-san-ngay-uu-dai.html" target="_blank">Xem chi tiết</a></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
@push('scripts')
    <script>
        const listImage = {
            anh_sp: [{
                    image: `https://anphat.com.vn/media/product/47506_`
                },
