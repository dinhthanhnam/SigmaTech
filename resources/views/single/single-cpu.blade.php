      ...
      <div class="bg-white product-info-container">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                      <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $socket }}</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                    ...
                    <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                      <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $base_clock }}</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Tốc độ tối đa&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                    <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                      <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $max_clock }}</span>
                    </td>
                  </tr>
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Số nhân CPU&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Số luồng CPU&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Bộ nhớ hỗ trợ&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Kích thước bộ nhớ tối đa&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Số kênh bộ nhớ tối đa&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Điện áp tiêu thụ tối đa&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Công suất cơ bản&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
                  ...
                  <tr>
                    <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                      <p>
                        <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                          <strong>
                            <span style="line-height: 115%; color: black;">Thuật in thạch bản&nbsp;&nbsp;</span>
                          </strong>
                        </span>
                      </p>
                    </td>
        ...
        <div class="pro-info-center">
          ...
          <div class="pro-info-summary">
            ...
            <span class="item">
              <i class="fa fa-check-circle"></i>Số lõi: {{ $core_count . ' / ' . 'Số luồng: ' . $thread_count }}
            </span>
            <span class="item">
            ...
            <span class="item hide d-block">
              <i class="fa fa-check-circle"></i>Các loại bộ nhớ (tùy vào bo mạch chủ) : {{ $supported_memory }}
            </span>
            <span class="item hide d-block">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <b style="color: #ce0707" class="text-18 js-pro-total-price" data-price="42990000"> {{ $dealprice }} đ
                    </b>
                ...
                <tr>
                  ...
                  <td>
                    <span style="color: #0030f2;" class="font-500">👉Quét ZALOPAY - Giảm liền tay ưu
                      ...
                      01/10/2024 đến 30/11/2024. <a href="https://www.anphatpc.com.vn/quet-zalopay-san-ngay-uu-dai.html"
        ...
        <div class="product-detail-info-right">
          ...
          <div class="store-address-container">
            <p style="display: flex;">
              ...
              <b style="color:red;display: inline-block;">Mua hàng Online toàn quốc: <br> (Hotline: 1900.0323 - Phím 1 hoặc 0913.367.005)</b>
            </p>
          </div>
          ...
          <div class="pd-static-item">
            ...
            <div class="static-info">
              ...
              <div id="js-out-stock" style="display: none;font-weight: bold;">Kho hàng: <span class="red">Liên hệ</span></div>
            </div>
          </div>
          <div class="pd-static-item">
            ...
            <div class="static-info">
              <ul class="ul" style="line-height:25px;">
                <li> <i class="fa fa-check"></i> <a href="javascript:void(0)" target="blank">Hướng dẫn đặt hàng Flash Sale</a> </li>
                <li> <i class="fa fa-check"></i> <a href="javascript:void(0)" target="blank">Hướng dẫn mua hàng</a> </li>
                <li> <i class="fa fa-check"></i> <a href="{{ route('pages.warranty-policy') }}" target="blank">Chính sách bảo hành đổi trả</a> </li>
                <li> <i class="fa fa-check"></i> <a href="javascript:void(0)" target="blank">Chính sách mua trả góp</a> </li>
                <li> <i class="fa fa-check"></i> <a href="{{ route('pages.shipping-policy') }}" target="blank">Chính sách giao hàng</a> </li>
                <li> <i class="fa fa-check"></i> <a href="javascript:void(0)" target="blank">Chính sách bảo hành tận nhà</a> </li>
                <li> <i class="fa fa-check"></i> <a href="javascript:void(0)" target="blank">Hỗ trợ khách hàng dự án, doanh nghiệp </a> </li>
              </ul>
            </div>
          </div>
          <div class="pd-static-item">
          ...
          <div>
            <p><b><font color="red">➤ KHUYẾN MẠI CỰC HOT ĐỪNG BỎ LỠ !!!</font></b></p>
            <a href="#" target="new"><img src="{{ asset('assets/img/deal/nbln0887.jpg') }}"></a>
          </div>
          <div>
            <a href="#" target="new"><img src="{{ asset('assets/img/deal/msi-katana-15-b13vfk.jpg') }}"></a>
          </div>
          <div>
          ...
          <table style="width: 100.0%;" border="1" width="100%">
            <tbody>
              ...
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                  <p>
                    <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">
                      <strong>
                        <span style="line-height: 115%; color: black;">Tốc độ cơ bản&nbsp;&nbsp;</span>
                      </strong>
                    </span>
                  </p>
                </td>
              ...
              <tr>
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $core_count }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $thread_count }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $p_core_count }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $e_core_count }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
              ...
              <tr>
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $max_power_draw }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $base_power }}</span>
                </td>
              </tr>
              <tr>
                <td style="width: 226.95pt; padding: .75pt .75pt .75pt .75pt;" width="303">
              ...
              <tr>
                ...
                <td style="width: 578.2pt; padding: .75pt; text-align: center;" width="771">
                  <span style="font-family: arial, helvetica, sans-serif; font-size: 10pt;">{{ $lithography }}</span>
                </td>
              </tr>
            </tbody>
          </table>
